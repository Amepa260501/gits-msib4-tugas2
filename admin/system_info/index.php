		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">Welcome Content</label>
	             <textarea name="welcome_message" id="" cols="30" rows="10" class="form-control"><?php echo  stripslashes($_settings->info('welcome_message')) ?></textarea>
			</div>
			<div class="form-group">
			...
			<div class="form-group d-flex justify-content-center">
				<img class="img-fluid img-thumbnail" src="profile_asset/images/fotoku.png">
			</div>
