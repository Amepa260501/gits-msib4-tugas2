...
$perkenalan = $conn->query("SELECT * FROM system_info");
while($row = $perkenalan->fetch_assoc()){
    $contact[$row['meta_field']] = $row['meta_value'];
}
...
?>
   ...
   <section id="about">
      ...
      <div class="row">
         ...
         <img class="profile-pic" src="profile_asset/images/fotoku.png">
            ...
            <div class="ten columns flex-container">
               ...
               <div class="flexslider">
                  ...
                  <ul class="slides">
                     ...
                     <li>
                        <blockquote>
                           <p>Kegagalan Hanyalah Kesempatan Untuk Memulai Lagi, Kali Ini Lebih Cerdas.
                     ...
                     <li>
                        <blockquote>
                           <p>Only Two Things Are Infinite, The Universitas And Human Stupidity And I'M Not Sure About The Former
                           </p>
                           <cite>Albert Einsten</cite>
                        </blockquote>
                     </li> <!-- slide ends -->
